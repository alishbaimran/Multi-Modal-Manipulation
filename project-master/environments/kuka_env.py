...
class Kuka:
    ...
    def __init__(self,
        ...
        if small_constraints:
            ...
            self.min_y, self.max_y = -0.22, 0.22
            self.min_z, self.max_z = -0.2, 0.5
        else:
            self.min_x, self.max_x = 0.35, 0.65
    ...
    def reset(self):
        ...
        """
        self.kuka_uid = p.loadURDF(os.path.join(self.urdf_root_path, "my_kuka_iiwa.urdf"))
        ...
        p.enableJointForceTorqueSensor(self.kuka_uid, self.kuka_gripper_index)
    ...
    def getActionDimension(self):
        ...
        return 3  # position x,y,z and roll/pitch/yaw euler angles of end effector
    ...
    def getObservation(self):
        ...
        (_, _, ft_reading, _) = p.getJointState(self.kuka_uid, self.kuka_gripper_index)

        return np.array(ft_reading), observation
