...
from environments.test_ft_sensor_reading import DynamicUpdate, Container
...
class KukaPegInsertionGymEnv(SRLGymEnv):
    ...
    def __init__(self,
        ...
        # connect to PyBullet using GUI
        # adjust the view angle of the environment using p.resetDebugVisualizerCamera()
        if self._renders:
